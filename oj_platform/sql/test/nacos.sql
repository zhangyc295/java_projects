...
(
    ...
    `group_id`  varchar(128) NOT NULL COMMENT 'group_id',
    `tenant_id` varchar(128) DEFAULT '' COMMENT 'tenant_id',
    `nid`       bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'nid, 自增⻓标识',
    PRIMARY KEY (`nid`),
...
(
    ...
    `quota`             int(10) unsigned NOT NULL DEFAULT '0' COMMENT '配额，0表示使⽤默认值',
    `usage`             int(10) unsigned NOT NULL DEFAULT '0' COMMENT '使⽤量',
    `max_size`          int(10) unsigned NOT NULL DEFAULT '0' COMMENT '单个配置大小上限，单位为字节，0表示使⽤默认值',
    `max_aggr_count`    int(10) unsigned NOT NULL DEFAULT '0' COMMENT '聚合⼦配置最大个数，，0表示使⽤默认值',
    `max_aggr_size`     int(10) unsigned NOT NULL DEFAULT '0' COMMENT '单个聚合数据的⼦配置大小上限，单位为字节，0表示使⽤默认值',
